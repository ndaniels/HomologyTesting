...
for sunid in sunids:
    ...
    if aligner == SMURF:
        executable = SMURF_HMMBUILD_EXECUTABLE
        preparse_executable = SMURF_PREPARSE_EXECUTABLE
        hmm_filename = SMURF_HMM_FILENAME
        hmmbuild_options = SMURF_HMMBUILD_OPTIONS
    elif aligner == HMMER:
